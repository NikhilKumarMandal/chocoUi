            ...
            return (
              <>
                <header className="bg-gradient-to-r from-purple-600 to-blue-600">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                      ...
                      <nav className="hidden md:flex items-center space-x-4 sm:space-x-8">
                        ...
                        <a href="#" className="text-white hover:text-gray-200 transition-colors">Work</a>
                        <a href="#" className="bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors ml-2">Sign Up</a>
                      </nav>
                  ...
                  <div className={mobileMenuClass}>
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-purple-700">Home</a>
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-purple-700">About</a>
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-purple-700">Services</a>
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-purple-700">Contact</a>
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-purple-700">Work</a>
                      <a href="#" className="block px-3 py-2 rounded-md text-base font-medium bg-white text-purple-600 hover:bg-gray-100 w-24 text-center">Sign Up</a>
                    </div>
                  </div>
                </header>
              </>
