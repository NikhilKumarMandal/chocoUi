      ...
      codeSnippets: [
        {
          ...
          function Footer4() {
            return (
              <footer className="w-screen bg-[#603F26] text-[#FFEAC5] py-16 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-[#7F6450]/30 to-transparent"></div>
          
                <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#FFEAC5]/20 to-transparent"></div>
                ...
                <div className="w-full px-0 relative z-10">
                  <div className="w-full px-4 sm:px-6 lg:px-8">
                      ...
                      <div className="lg:w-1/3 space-y-8">
                        <div className="flex items-center gap-3">
                          ...
                          <a href="#" className="text-2xl font-bold tracking-tighter">
                            Choco<span className="text-[#FFEAC5]/80">UI</span>
                          </a>
                        </div>
          
                        <p className="text-[#FFEAC5]/80 text-sm leading-relaxed">
                        ...
                        <div className="pt-2">
                          <a
                            href="#"
                            className="inline-flex items-center text-sm font-medium text-[#FFEAC5] hover:text-[#FFEAC5]/80 transition-colors group"
                          >
                            <span className="border-b border-transparent group-hover:border-[#FFEAC5]/50 transition-all">
                      ...
                      <div className="lg:w-2/3">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                          {[
                            {
                              title: "Products",
                              items: ["Components", "Templates", "Pricing", "FAQ"],
                            },
                            {
                              title: "Company",
                            ...
                            {
                              title: "Resources",
                              items: ["Docs", "Learn", "Showcase", "GitHub"],
                            },
                            {
                              title: "Legal",
                              items: ["Privacy", "Terms", "License", "Cookies"],
                            },
                          ].map((section) => (
                            <div key={section.title}>
                              <h3 className="text-sm font-medium text-[#FFEAC5]/80 uppercase tracking-wider mb-5">
                                {section.title}
                              </h3>
                              <ul className="space-y-3">
                                {section.items.map((item) => (
                                  <li key={item}>
                                    <a
                                      href="#"
                                      className="text-base text-[#FFEAC5] hover:text-[#FFEAC5]/80 transition-colors flex items-start group"
                                    >
                                      <span className="w-1 h-1 mt-2 mr-2 bg-[#FFEAC5]/50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                      {item}
                                    </a>
                                  </li>
                                ))}
                    ...
                    <div className="mt-16 pt-8 border-t border-[#7F6450]/50 flex flex-col md:flex-row justify-between items-center">
                      <p className="text-[#FFEAC5]/80 text-sm">
                      ...
                      <div className="flex space-x-6 mt-4 md:mt-0">
                        {[
                          ...
                          <a
                            key={social.name}
                            href="#"
                            className="text-[#FFEAC5]/60 hover:text-[#FFEAC5] transition-colors hover:-translate-y-0.5 transform"
