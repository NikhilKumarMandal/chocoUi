...
function FooterPage() {
      ...
      codeSnippets: [
        {
          ...
          function Skeleton() {
            return (
              <div className="w-full max-w-[340px] p-4 border rounded-lg shadow-md animate-pulse bg-white mx-auto m-4">
      ...
      codeSnippets: [
        {
          ...
          const Skeleton = () => {
            return (
              <div className="w-full max-w-sm p-4 border rounded-lg shadow-sm animate-pulse bg-white mx-auto m-4">
      ...
      codeSnippets: [
        {
          ...
          const Skeleton = () => {
            return (
              <div className="w-full max-w-lg p-5 border rounded-lg shadow-sm animate-pulse bg-white mx-auto m-4">
                <div className="h-6 w-1/3 bg-gray-200 rounded mb-4"></div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 ">
      <h1 className="text-3xl font-bold font-['Bricolage'] tracking-tight text-gray-900">Skeleton Components</h1>
