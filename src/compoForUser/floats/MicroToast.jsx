    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          initial={{ opacity: 0, y: position.includes('top') ? -20 : 20, x: position.includes('right') ? 20 : -20 }}
        ...
        >
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-start gap-2">
              <div className={`p-1.5 rounded-md ${toastTypes[type].border} ${toastTypes[type].bg} mt-0.5`}>
