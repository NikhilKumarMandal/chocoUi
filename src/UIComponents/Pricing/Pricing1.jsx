    ...
    <div className="bg-[#3E5879] py-12 px-4 sm:px-6 lg:px-8 min-h-screen rounded-3xl">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-xl text-white mb-4">Pricing that grows with you</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="bg-white rounded-xl p-6 border border-[#A1E3F9]/50 hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#578FCA] mb-4">The essentials to provide your best work for clients.</p>
            <div className="mb-6">
              <span className="text-3xl font-bold text-[#3674B5]">{isAnnual ? '$15' : '$19'}</span>
          ...
          <div className="bg-white rounded-xl p-6 border border-[#A1E3F9]/50 hover:-translate-y-2 hover:shadow-lg transition-all duration-300 relative">
            <span className="absolute top-3 right-3 px-2.5 py-0.5 bg-[#A1E3F9] text-[#3674B5] rounded-full text-xs font-medium">Popular</span>
            <h3 className="text-xl font-semibold text-[#3674B5] mb-2">Freelancer</h3>
            <p className="text-[#578FCA] mb-4">The essentials to provide your best work for clients.</p>
            <div className="mb-6">
              <span className="text-3xl font-bold text-[#3674B5]">{isAnnual ? '$23' : '$29'}</span>
              <span className="text-[#578FCA]">/month</span>
            </div>
            ...
            <ul className="mt-6 space-y-3">
              ...
              <li className="text-[#3674B5]">✔ Up to 1,000 subscribers</li>
              <li className="text-[#3674B5]">✔ Basic analytics</li>
              <li className="text-[#3674B5]">✔ 48-hour support response time</li>
            </ul>
          </div>

          <div className="bg-white rounded-xl p-6 border border-[#A1E3F9]/50 hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
            <h3 className="text-xl font-semibold text-[#3674B5] mb-2">Startup</h3>
            <p className="text-[#578FCA] mb-4">A plan that scales with your rapidly growing business.</p>
            <div className="mb-6">
              <span className="text-3xl font-bold text-[#3674B5]">{isAnnual ? '$47' : '$59'}</span>
              <span className="text-[#578FCA]">/month</span>
            </div>
            <button className="w-full py-2 px-4 rounded-lg bg-[#A1E3F9] text-[#3674B5] hover:bg-[#578FCA] hover:text-white">
              Buy plan
            ...
            <ul className="mt-6 space-y-3">
              ...
              <li className="text-[#3674B5]">✔ 24-hour support response time</li>
              <li className="text-[#3674B5]">✔ Marketing automations</li>
            </ul>
          </div>

          <div className="bg-white rounded-xl p-6 border border-[#A1E3F9]/50 hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
            <h3 className="text-xl font-semibold text-[#3674B5] mb-2">Enterprise</h3>
            <p className="text-[#578FCA] mb-4">Dedicated support and infrastructure for your company.</p>
            <div className="mb-6">
              <span className="text-3xl font-bold text-[#3674B5]">{isAnnual ? '$79' : '$99'}</span>
              <span className="text-[#578FCA]">/month</span>
            </div>
            <button className="w-full py-2 px-4 rounded-lg bg-[#A1E3F9] text-[#3674B5] hover:bg-[#578FCA] hover:text-white">
              Buy plan
            ...
            <ul className="mt-6 space-y-3">
              ...
              <li className="text-[#3674B5]">✔ Advanced analytics</li>
              <li className="text-[#3674B5]">✔ 1-hour, dedicated support response time</li>
              <li className="text-[#3674B5]">✔ Marketing automations</li>
