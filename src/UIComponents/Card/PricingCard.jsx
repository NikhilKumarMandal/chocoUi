  ...
  return (
    <div 
      className={`relative w-full max-w-sm mx-auto rounded-xl overflow-hidden shadow-lg transition-all duration-300 ${
        featured ? "border-2 border-blue-500 transform md:scale-105 z-10" : "border border-gray-200"
      } ${isHovered ? "shadow-xl" : ""}`}
    ...
    >
      ...
      <div className={`p-6 ${featured ? "bg-gradient-to-b from-blue-50 to-white" : "bg-white"}`}>
