  ...
  return (
    <>
     <div className="flex justify-center items-center min-h-screen">
         <div className="relative w-screen max-w-sm border border-gray-600 rounded-2xl bg-gray-100 px-4 py-8 sm:px-6 lg:px-8"
            aria-modal="true"
            role="dialog"
            tabIndex="-1"
            >
            ...
            <div className="mt-4 space-y-6">
                ...
                <li className="flex items-center gap-4">
                    ...
                    <form>
                        ...
                        <button
                        className="h-8 w-12 rounded-sm border-gray-200 bg-gray-50 p-0 text-center text-xs text-gray-900 [-moz-appearance:_textfield] focus:outline-hidden [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"
                        >Add</button>
