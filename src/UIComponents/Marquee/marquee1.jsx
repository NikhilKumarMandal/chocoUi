...
const cohortMembers = [
  {
    ...
    quote:
      "Thanks to the guidance of Hitesh Sir and Piyush Sir, I mastered the art of turning complex ideas into beautiful, responsive UIs that users love.",
    tech: ["React", "TypeScript", "Tailwind"],
    img: "https://images.unsplash.com/photo-1607346256330-dee7af15f7c5?q=80&w=2106&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Priya Sharma",
    role: "Full Stack Developer",
    quote:
      "This cohort gave me the confidence to build scalable, production-ready applications using the modern tech stack. It truly bridged the gap between theory and real-world development.",
    tech: ["Node.js", "Next.js", "MongoDB"],
    img: "https://plus.unsplash.com/premium_photo-1682089810582-f7b200217b67?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Sneha Nair",
    role: "Backend Developer",
    quote:
      "From APIs to databases, this cohort helped me understand the backbone of modern applications and how to build them in a clean, scalable way.",
    tech: ["Python", "Django", "PostgreSQL"],
    img: "https://images.unsplash.com/photo-1573165850883-9b0e18c44bd2?q=80&w=1976&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Arjun Iyer",
    role: "DevOps Engineer",
    quote:
      "Learning about cloud infrastructure and CI/CD pipelines in this cohort was eye-opening. I can now automate and deploy with confidence.",
    tech: ["Docker", "AWS", "CI/CD"],
    img: "https://plus.unsplash.com/premium_photo-1682089869602-2ec199cc501a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Kavya Reddy",
    role: "Mobile Developer",
    quote:
      "This cohort helped me take my mobile dev skills to the next level. I now understand how to deliver seamless, high-performance apps for iOS and Android.",
    tech: ["React Native", "Swift", "Kotlin"],
    img: "https://images.unsplash.com/photo-1667037788724-3bdd9ca61df0?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Neha Kapoor",
    role: "QA Engineer",
    quote:
      "Quality matters. This cohort taught me how to build and automate test cases that ensure our applications are reliable and bug-free.",
    tech: ["Cypress", "Jest", "Testing Library"],
    img: "https://images.unsplash.com/photo-1479936343636-73cdc5aae0c3?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Manish Dubey",
    role: "Cloud Architect",
    quote:
      "I now have the skills to design resilient, scalable cloud infrastructures that can handle real-world traffic and complexity — all thanks to this incredible learning journey.",
    tech: ["Azure", "Terraform", "Kubernetes"],
    img: "https://plus.unsplash.com/premium_photo-1691030254390-aa56b22e6a45?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Ananya Joshi",
    role: "Product Manager",
    quote:
      "This cohort gave me the technical foundation I needed to effectively lead development teams and shape product strategies with clarity and vision.",
    tech: ["Jira", "Agile", "Roadmaps"],
