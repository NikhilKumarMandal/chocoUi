    ...
    const [projects, setProjects] = useState([
        {
          ...
          team: [
            ...
            { name: "Jane Smith", avatar: "JS", color: "bg-purple-100 text-purple-600" },
            { name: "Bob Johnson", avatar: "BJ", color: "bg-yellow-100 text-yellow-600" }
          ],
          status: "In Progress",
          progress: 75,
          dueDate: "2024-04-15",
        ...
        },
        {
          ...
          name: "Mobile App",
          team: [
            { name: "Alice Williams", avatar: "AW", color: "bg-green-100 text-green-600" },
            { name: "Charlie Brown", avatar: "CB", color: "bg-red-100 text-red-600" }
          ],
          status: "Completed",
          progress: 100,
          dueDate: "2024-03-30",
      ...
      return (
        <div className="container p-4 sm:p-6 max-w-5xl mx-auto">
          ...
          {isMobileView ? (
            <div>
              {filteredAndSortedProjects.map(project => renderMobileCard(project))}
            </div>
          ) : (
