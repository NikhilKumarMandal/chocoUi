...
const Table_08 = () => {
  ...
  return (
    <div className="container p-2 sm:p-6 max-w-6xl mx-auto">
                ...
                <React.Fragment key={user.id}>
                  ...
                  >
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div
                          className={`h-10 w-10 rounded-full bg-gradient-to-r ${user.gradient} flex items-center justify-center text-white font-medium`}
                        >
                          {user.initials}
                        </div>
                        <div className="ml-4">
                  ...
                  {selectedRow === user.id && (
                    <tr>
                      <td
                        colSpan="5"
                        className="px-4 sm:px-6 py-4 bg-gray-800 border-t border-gray-700"
                      >
