            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${selectedProduct.categoryColor}`}>
              ...
              <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-xl font-bold">{selectedProduct.sales.toLocaleString()}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-gray-500">Revenue</h3>
                  <p className="text-xl font-bold">${selectedProduct.revenue.toLocaleString()}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-gray-500">Growth</h3>
                  <p className={`text-xl font-bold ${selectedProduct.growthColor}`}>{selectedProduct.growth}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-gray-500">Stock</h3>
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-4 md:mb-0">Sales Dashboard</h1>
              ...
              {timeRangeOptions.map((option) => (
                <button 
                  ...
                  className={`flex-1 sm:flex-none px-4 py-2 text-sm font-medium transition-colors ${
                    timeRange === option.value ? "bg-blue-50 text-blue-600" : "text-gray-500 hover:bg-gray-50"
                  }`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
            ...
            <p className="text-xl sm:text-2xl font-bold text-gray-900">${metricsData[timeRange].totalSales.toLocaleString()}</p>
            <p className={`text-sm ${metricsData[timeRange].salesChange.includes('+') ? 'text-green-600' : 'text-red-600'}`}>
              {metricsData[timeRange].salesChange} from last period
            </p>
          </div>
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Orders</h3>
            <p className="text-xl sm:text-2xl font-bold text-gray-900">{metricsData[timeRange].orders.toLocaleString()}</p>
            <p className={`text-sm ${metricsData[timeRange].ordersChange.includes('+') ? 'text-green-600' : 'text-red-600'}`}>
              {metricsData[timeRange].ordersChange} from last period
            </p>
          </div>
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Customers</h3>
            <p className="text-xl sm:text-2xl font-bold text-gray-900">{metricsData[timeRange].customers.toLocaleString()}</p>
            <p className={`text-sm ${metricsData[timeRange].customersChange.includes('+') ? 'text-green-600' : 'text-red-600'}`}>
              {metricsData[timeRange].customersChange} from last period
            </p>
          </div>
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Average Order</h3>
            <p className="text-xl sm:text-2xl font-bold text-gray-900">${metricsData[timeRange].avgOrder.toLocaleString()}</p>
            <p className={`text-sm ${metricsData[timeRange].avgOrderChange.includes('+') ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedProducts.map(product => (
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap">{product.sales.toLocaleString()}</td>
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap">${product.revenue.toLocaleString()}</td>
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                        <span className={product.growthColor}>{product.growth}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
