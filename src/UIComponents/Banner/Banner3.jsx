        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-3/5 p-6 md:p-8 lg:p-12">
            <div className="max-w-lg">
              ...
              <span className="inline-block px-4 py-1 mb-4 text-sm 
              ...
              <p className="text-gray-600 mb-6">
                Explore our newest arrivals featuring modern designs and 
                premium quality. Limited time offer with exclusive deals.
              </p>

             
              <div className="flex flex-wrap gap-3">
                <button className="px-6 py-2.5 bg-gray-900 text-white 
                                rounded-lg hover:bg-gray-800 transition-colors 
                                duration-200">
                  Shop Now
                </button>
                <button className="px-6 py-2.5 border border-gray-300 
