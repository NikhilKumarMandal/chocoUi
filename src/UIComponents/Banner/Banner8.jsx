              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    Allow access to your location to get personalized
                    recommendations and nearby services.
                  </p>
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Your location data is only used when you're using the app
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                        Invite friends to join and both of you will receive a
                        $25 credit when they sign up.
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-white text-center md:text-left">
                ...
                <p className="mt-2 text-white/80 max-w-md">
                  Your feedback helps us improve. Take a moment to rate your
