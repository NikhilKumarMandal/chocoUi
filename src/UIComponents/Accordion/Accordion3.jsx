 ...
 const AccordionItem = ({ header, text }) => {
      ...
      return (
        ...
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-600 dark:bg-gray-800 rounded-sm">
          ...
          >
            <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-primary/10 text-red-400
            dark:bg-white/10">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='w-6 h-6 text-amber-700'>
