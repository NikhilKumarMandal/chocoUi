    ...
    <div className="flex justify-center items-center min-h-screen ">
      <div className="relative">
        ...
        <button
          ...
          className="px-5 py-2 bg-neutral-800 text-neutral-300 rounded-lg
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2">
              <div className="w-3 h-3 bg-neutral-800 rotate-45 
            ...
            <div className="p-5 space-y-4">
              <p className="text-neutral-300 text-sm leading-relaxed">
                Minimal design focuses on the essential elements of a user interface. 
                It emphasizes simplicity and clarity, removing unnecessary decorative 
              ...
              <div className="pt-2 flex justify-end border-t border-neutral-700">
                <button
                  ...
                  className="px-4 py-1.5 text-sm text-neutral-400 
