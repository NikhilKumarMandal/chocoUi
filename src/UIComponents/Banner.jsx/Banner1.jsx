    ...
    <div className="space-y-4 p-4 max-w-4xl mx-auto">
      ...
      {visibleBanners.success && (
        <div className="flex items-center justify-between px-4 py-3 
          ...
          <button onClick={() => closeBanner('success')} 
      ...
      {visibleBanners.info && (
        <div className="flex items-center justify-between px-4 py-3 
          ...
          <button onClick={() => closeBanner('info')} 
      ...
      {visibleBanners.warning && (
        <div className="flex items-center justify-between px-4 py-3 
          ...
          <button onClick={() => closeBanner('warning')} 
      ...
      {visibleBanners.error && (
        <div className="flex items-center justify-between px-4 py-3 
          ...
          <button onClick={() => closeBanner('error')} 
      ...
      {visibleBanners.promo && (
        <div className="flex items-center justify-between px-4 py-3 
          ...
          <button onClick={() => closeBanner('promo')} 
