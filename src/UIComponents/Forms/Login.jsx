  ...
  return (
   ...
   <div className='p-5'>
    ...
    <div class="mb-5">
        ...
        <input type="email" id="" class="bg-gray-900 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
         focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
          dark:focus:ring-blue-900 dark:focus:border-blue-900" placeholder="name@chcoui.live" required />
    </div>
    <div class="mb-5">
    ...
    <div class="flex items-start mb-5">
        ...
        <input id="remember" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3
