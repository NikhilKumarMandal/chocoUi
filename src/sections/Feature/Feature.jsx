      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`h-full p-6 rounded-xl border border-[#FFDBB5] ${feature.color} ${feature.textColor || "text-[#603F26]"} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] overflow-hidden`}
              >
                ...
                <h3
                  className={`mb-3 text-xl font-bold ${feature.textColor ? "text-white" : "text-[#603F26]"} group-hover:text-[#6C4E31] transition-colors duration-300 font-['Bricolage']`}
                >
                  {feature.title}
                </h3>
                <p
                  className={`${feature.textColor ? "text-white/90" : "text-[#6C4E31]/90"} mb-4 font-['Inter']`}
                >
                  {feature.description}
                </p>
