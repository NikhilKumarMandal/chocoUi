...
import { Github, Twitter, Heart, Mail, FileText, Globe, Shield } from "lucide-react";
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
          ...
          >
            ...
            <p className="mt-4 text-sm text-[#603F26]/80 font-['Inter'] leading-relaxed">
              Modern, accessible React components that make your applications look professional with minimal effort.
            </p>
          ...
          >
            <h3 className="text-md font-semibold text-[#603F26] mb-4 font-['Bricolage']">Resources</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/docs" className="text-[#603F26]/80 hover:text-[#603F26] text-sm flex items-center gap-2 transition-all duration-300 relative group font-['Inter']">
              ...
              <li>
                <Link to="/examples" className="text-[#603F26]/80 hover:text-[#603F26] text-sm flex items-center gap-2 transition-all duration-300 relative group font-['Inter']">
                  <Globe size={14} className="opacity-70 group-hover:opacity-100" />
                  <span>Examples</span>
                  <span className="absolute -bottom-0.5 left-0 h-0.5 bg-[#603F26] w-0 group-hover:w-full transition-all duration-500"></span>
                </Link>
              </li>
          ...
          <motion.div
            ...
            className="p-6 rounded-xl bg-white/30 backdrop-blur-sm border border-[#603F26]/10 shadow-lg"
          >
            <h3 className="text-md font-semibold text-[#603F26] mb-4 font-['Bricolage']">Legal</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/privacy" className="text-[#603F26]/80 hover:text-[#603F26] text-sm flex items-center gap-2 transition-all duration-300 relative group font-['Inter']">
              ...
              <li>
                <Link to="/terms" className="text-[#603F26]/80 hover:text-[#603F26] text-sm flex items-center gap-2 transition-all duration-300 relative group font-['Inter']">
                  <FileText size={14} className="opacity-70 group-hover:opacity-100" />
              ...
              <li>
                <Link to="/contact" className="text-[#603F26]/80 hover:text-[#603F26] text-sm flex items-center gap-2 transition-all duration-300 relative group font-['Inter']">
